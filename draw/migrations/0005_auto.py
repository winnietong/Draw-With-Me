...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field follower on 'Drawing'
        m2m_table_name = db.shorten_name(u'draw_drawing_follower')
    ...
    def backwards(self, orm):
        # Removing M2M table for field follower on 'Drawing'
        db.delete_table(db.shorten_name(u'draw_drawing_follower'))
    ...
    models = {
        ...
        u'draw.drawing': {
            ...
            'follower': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'follower'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['draw.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
